...
$$
\mathbf{R} = \mathbf{U\Sigma U^{\dagger}} = \underbrace{\mathbf{U_s\Sigma_s U^{\dagger}_s}}_{Signal\ Subspace} + \underbrace{\mathbf{U_n\Sigma_n U^{\dagger}_n}}_{Noise\ Subspace}
$$
