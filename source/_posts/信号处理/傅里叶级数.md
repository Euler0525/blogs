---
title: 傅里叶级数
description: '从正交集中的信号分解出发，推导傅里叶级数的三角形式与复指数形式，并整理奇偶性带来的简化。'
tags:
  - 傅里叶级数
categories: 信号处理
mathjax: true
...
其中 $\dfrac{a_0}{2}$ 称为信号的直流分量，$a_1\cos\omega t,b_1\sin\omega t$ 或 $A_1\cos(\omega t + \varphi_1)$ 称为信号的基波分量；$a_n\cos(n\omega t),b_n\sin(n\omega t)$ 或 $A_n\cos(n\omega t + \varphi_n)$ 称为信号的 $n$ 次谐波分量。
...
> \text{令 } \varphi_{-n} = -\varphi_n, A_{-n} = A_n,\\
