---
title: 二进制相移键控
description: '介绍 BPSK 的调制解调原理，结合 MATLAB 仿真、理论误码率分析和 FPGA 调制实现记录完整链路。'
tags:
  - BPSK
  - 采样定理
categories: 通信
...
其中带宽 $B = f_{smp} / 2$，比特能量与符号能量满足关系 $E_s=E_b \log_2 M$，则
...
- [GitHub | Euler0525/bpsk-gpu](https://github.com/Euler0525/bpsk-gpu/tree/develop)
